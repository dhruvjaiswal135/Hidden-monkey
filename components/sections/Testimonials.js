    ...
    <section className="relative py-8 md:py-12 bg-white" aria-label="Guest Reviews">
      <Container className="max-w-[1400px]">
            ...
            >
              ...
              >
                ...
                <div className="mb-3 opacity-30 flex items-center gap-0">
                  <svg className="w-5 h-5 text-[#FBB11A]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mt-8 md:mt-10 pt-6 md:pt-8 border-t border-[#E6E4DF]">
          <a
            href="/reviews"
            className="inline-flex items-center gap-2 text-[#128790] text-[13px] md:text-[14px] font-medium hover:gap-3 transition-all duration-300"
          >
            Read all stories
